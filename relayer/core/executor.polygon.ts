 ...
 * 
 * This executor implements the service process (μ) for Polygon Amoy.
 * 
...
// Note: Using ethers Wallet directly with manual nonce management
// @ethersproject/experimental NonceManager can be used if available
  ...
  async executeTransfer(
    ...
    try {
      ...
      const tx = await wallet.sendTransaction({
        ...
        gasLimit: 21000, // Standard MATIC transfer
        nonce,
        ...gasOptions,
      });
